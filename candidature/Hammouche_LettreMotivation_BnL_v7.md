...
Intelligent Luxembourg Heritage part de là. CER 0,88 % avec Qwen3-VL en few-shot — 4× sous Nautilus/Kraken fine-tuné (Schneider 2023), zéro GPU, zéro fine-tuning, localisation pixel bbox native. Mais le résultat n’est pas la partie intéressante. Ce qui l’est : le few-shot n’est pas seulement une technique de prompt — c’est la brique d’un cycle d’auto-amélioration. Il filtre les données SFT, amorce le QLoRA sur signal propre, synthétise des milliers de paires d’entraînement sans annotation humaine depuis les 10 880 pages de L’Union (1860–1869, CC0 BnL), et définit la récompense de référence pour le raffinement GRPO. 1 702 blocs annotés transformés en avantage architectural, pas en contrainte. Le pipeline est conçu pour connexion directe aux systèmes productifs BnL, piloté sous QUAPITAL-HERMES, EU AI Act Phase 0.

HIPE-OCRepair 2026 (ICDAR) organise le premier benchmark international de correction post-OCR par LLM incluant le luxembourgeois, via Impresso. La soumission est prête pour avril. La BnF a Gallica/ArGiMi. La KB Netherlands a Retrotool. Le corpus luxembourgeois manque dans les deux projets. Le nôtre est en CC0. Il sera mis à disposition pour accompagner les chercheurs dans l’usage des données ouvertes — au service du secteur bibliothèques, archives et musées. — Fichier PropILH.html joint, s’ouvre en double-cliquant, aucune installation requise.
