...
Intelligent Luxembourg Heritage part de là. CER 0,88 % avec Qwen3-VL few-shot — 4× sous Nautilus/Kraken fine-tuné, zéro GPU, zéro fine-tuning, bbox pixel native. Mais le résultat n’est pas la partie intéressante. Ce qui l’est : le few-shot n’est pas une technique de prompt — c’est la brique d’un cycle d’auto-amélioration. Il filtre les données SFT, amorce le QLoRA (0,88 % vs 3,54 % zero-shot), synthétise des paires d’entraînement sans annotation humaine depuis les 10 880 pages de L’Union 1860–69 (CC0 BnL), et définit la récompense GRPO. Pool : Ground Truth Pack (33 000 lignes, 99,95 %), Sample Pack (11 titres DE/FR, 1845–77), D’Wäschfra 1868 (lb XIXe). La contrainte de données devient l’architecture. Le pipeline est conçu pour connexion directe aux systèmes productifs BnL, piloté sous QUAPITAL-HERMES, EU AI Act Phase 0.
