...
Ce projet a été identifié à partir d’une étude de valorisation IA appliquée à la BnL sur des sources publiques et ouvertes, et en particulier du programme AI4GOV, en utilisant l’AI Value Framework (un cadre basé sur la composition de l’état de l’art : McKinsey, Gartner, Forrester). Parmi six cas d’usage évalués dans le secteur bibliothèques, archives et musées, ILH a été classé priorité 1. Il pourra vous être présenté lors de l’entretien comme exemple de projet IA/Data piloté sous QUAPITAL-HERMES (la méthode de pilotage de projets IT de l’État luxembourgeois), avec trois jalons de décision.
