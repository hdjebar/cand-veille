...
Ce projet a été identifié à partir d’une étude de valorisation IA appliquée à la BnL sur des sources publiques et ouvertes, et en particulier du programme AI4GOV, en utilisant l’AI Value Framework (un cadre basé sur la composition de l’état de l’art, McKinsey, Gartner, Forrester, en sept étapes : évaluer la maturité, cadrer le périmètre, identifier les opportunités, filtrer les cas d’usage, scorer le portefeuille, définir la solution, mesurer la valeur). Parmi six cas d’usage évalués, ILH a été classé Tier 1. Il pourra vous être présenté lors de l’entretien, notamment comme exemple de projet IA/Data piloté sous QUAPITAL-HERMES avec trois jalons de décision.
