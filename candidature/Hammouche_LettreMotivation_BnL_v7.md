...
Et en ce moment, HIPE-OCRepair 2026 (ICDAR, 31 août–2 sept.) organise un benchmark international de correction post-OCR par LLM sur documents historiques multilingues — incluant le luxembourgeois via Impresso, projet que le FNR cofinance. La soumission ILH au leaderboard HuggingFace est prête pour la phase d’évaluation du 6 au 8 avril : première comparaison VLM vs BERT sur le GT BnL CC0 (6 723 blocs, presse LU DE/FR/LB). Un fichier de présentation interactif est disponible hors ligne sur demande.
