...
Ce projet a été identifié à partir d’une étude de valorisation IA conduite sur des sources publiques et ouvertes de la BnL, en appliquant l’AI Value Discovery Framework (une méthode en cinq étapes — cartographier, identifier, aligner, évaluer, livrer — utilisée par McKinsey, Gartner et Forrester pour prioriser les investissements IA avant d’engager des ressources). Il pourra vous être présenté lors de l’entretien comme exemple concret de projet IA/Data piloté sous QUAPITAL-HERMES avec trois jalons de décision.
