...
Et en ce moment, HIPE-OCRepair 2026 (ICDAR, 31 août–2 sept.) organise un benchmark international de correction post-OCR par LLM sur documents historiques multilingues — incluant le luxembourgeois via Impresso, projet que le FNR cofinance. La soumission ILH au leaderboard HuggingFace est prête pour la phase d'évaluation du 6 au 8 avril : première comparaison VLM vs BERT sur le GT BnL CC0 (6 723 blocs, presse LU DE/FR/LB). L'évaluation locale sur le scorer officiel donne cMER 1,38 % contre 3,68 % pour Nautilus/Kraken fine-tuné (Schneider 2023) — zero-shot. Le corpus multilingue FR/DE/LB post-correction ainsi produit s'inscrit dans le même mouvement que ce que font la BnF avec Gallica/ArGiMi et la KB Netherlands avec Retrotool : contribuer des données patrimoniales de haute qualité à l'infrastructure IA européenne. L'initiative ALT-EDIC (CENL, 2025) cherche exactement ce type de corpus ; le nôtre est le seul à couvrir le luxembourgeois. Un fichier de présentation interactif est disponible hors ligne sur demande.
